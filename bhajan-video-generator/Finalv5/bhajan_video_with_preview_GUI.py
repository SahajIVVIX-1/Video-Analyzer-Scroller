...
if not os.path.exists(FFMPEG_BIN_PATH):
    ...
    FFMPEG_BIN_PATH = r"P:\03_Projects\Video-Analyzer-Scroller\ffmpeg\bin\ffmpeg.exe"
...
class VideoWorker(QThread):
    ...
    def __init__(self, pdf_config_list, output_path, ending_img_path, ending_duration, fps=30, hardware_encoder=None, selected_date=None):
        super().__init__()
        self.fps = fps
...
class MainWindow(QWidget):
    ...
    def start_processing(self):
        ...
        self.worker = VideoWorker(pdf_configurations, full_output_path, ending_image, 3, fps=selected_fps, hardware_encoder=self.hardware_encoder, selected_date=selected_datetime)
