...
class MainWindow(QWidget):
    def __init__(self):
        ...
        # Apply Dark Theme - Premium Slate/Indigo (Sleek, Modern, High-Contrast)
        self.setStyleSheet("""
            QWidget {
            ...
            QProgressBar::chunk {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #7c5cff, stop:1 #6366f1);
                border-radius: 7px;
            }
        ...
        title.setStyleSheet("font-size: 30px; color: #7c5cff; margin-bottom: 8px; font-weight: bold; background: transparent;")
        ...
        self.start_btn.setStyleSheet("""
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #7c5cff, stop:1 #6343e0);
                color: #ffffff;
                font-size: 13px;
                font-weight: bold;
                border: none;
            ...
            QPushButton:hover {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #9075ff, stop:1 #7252f2);
            }
            QPushButton:pressed {
                background: #6343e0;
            }
